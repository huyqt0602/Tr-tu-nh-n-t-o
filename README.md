...
| Leo đồi khởi tạo ngẫu nhiên (Random Restart HC) | Thực hiện leo đồi nhiều lần (tối đa 20 lần) từ các điểm xuất phát ngẫu nhiên khác nhau. Nếu một lần chạy đạt đích, kết nối đường đi bằng BFS. Trả về đường đi tốt nhất tìm được. |
